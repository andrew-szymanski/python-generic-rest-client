...
def main(argv=None):
    ...
    cat_options.add_option("-x", "--exec", help="execute helper command, in format 'helpers/my_helper.my_method.  Method must always take only json file as argument (optional) / input", default="NOT_SPECIFIED")
